// =========================
// Landing + Analyze + Diagnose screens
// =========================

// ====== USR-01: Landing Page ======
const Landing = ({ onStart, isMobile }) => {
    ...
    <div style={{ background: "var(--bg)" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: 26, fontSize: 13, color: "var(--ink-2)", alignItems: "center" }}>
            ...
            <button className="btn btn-ghost btn-sm">ログイン</button>
          </div>
        }
      </div>
      ...
      <div style={{ padding: "0 56px 8px", display: "grid", gridTemplateColumns: "1.6fr 1fr", gap: 0, borderTop: "1px solid var(--line)" }}>
          <image-slot
          id="hero-main"
          src={window.STOCK?.hero}
          style={{ width: "100%", height: "320px", display: "block" }}
          shape="rect"
          placeholder="ヒーロー画像をドロップ（例：経営者・オフィス・面談の様子）">
        </image-slot>
...
// ====== USR-02: URL Analysis ======
const Analyze = ({ url, onDone, isMobile }) => {
      ...
      <div style={{ maxWidth: 760, margin: "0 auto" }}>
        ...
        <div style={{ borderTop: "1px solid var(--line-ink)", paddingTop: 22 }}>
          ...
          <div style={{
            ...
            {[
            { l: "業種", v: c.industry },
            { l: "従業員数", v: `${c.employeeCount} 名` },
            { l: "所在地", v: c.prefecture },
            { l: "売上規模", v: c.revenueLabel },
            { l: "設立", v: c.established },
            { l: "資本金", v: window.formatYen(c.capital) }].
            map((f, i) =>
            <div key={i} style={{
              ...
              borderLeft: i % 2 === 1 ? "1px solid var(--line)" : 0
                ...
                {editing ?
              <input className="input" defaultValue={f.v} /> :
          ...
          <div style={{ padding: "22px 0", borderBottom: "1px solid var(--line)" }}>
            ...
            {editing ?
            <textarea className="input" defaultValue={c.businessSummary} rows={4} /> :
...
const Diagnose = ({ onDone, isMobile }) => {
...
Object.assign(window, { Landing, Analyze, Diagnose });